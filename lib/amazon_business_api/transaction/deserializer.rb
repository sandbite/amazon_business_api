...
module AmazonBusinessApi
  class Transaction
    class Deserializer < AmazonBusinessApi::Deserializer
      ...
      references_one :buyer, deserializer: Customer, hash_attribute: :buyer
      references_one :payer, deserializer: Customer, hash_attribute: :payer
      references_many :associated_transaction_details, deserializer: AssociatedTransactionDetail, hash_attribute: :associatedTransactionDetails
      references_many :transaction_line_items, deserializer: TransactionLineItem, hash_attribute: :transactionLineItems
    end
  end
end
