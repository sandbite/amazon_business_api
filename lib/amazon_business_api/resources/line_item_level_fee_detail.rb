...
require_relative 'line_item_level_fee_apportionment_detail'

module AmazonBusinessApi
  class LineItemLevelFeeDetail < AmazonBusinessApi::Resource
    ...
    references_many :apportionment, to: LineItemLevelFeeApportionmentDetail
  end
end
